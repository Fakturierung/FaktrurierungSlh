 ...
 */
@Entity
@Table(name = "tbl_stn_plz", schema = "fak2")
public class MirrorPostleitzahl implements Serializable {
	...
	private List<MirrorPostleitzahlOrtsteil> postleitzahlOrtsteile;
	...
	public List<MirrorPostleitzahlOrtsteil> getPostleitzahlOrtsteile() {
		return postleitzahlOrtsteile;
	}

	public void setPostleitzahlOrtsteile(List<MirrorPostleitzahlOrtsteil> postleitzahlOrtsteile) {
