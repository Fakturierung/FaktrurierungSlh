 ...
 */
@Entity
@Table(name = "tbl_pr_preisliste_A", schema = "fak2")
public class MirrorBasisPL implements Serializable {
    ...
    @OneToOne
    private MirrorGewichtklasse gewichtklasse;
    ...
    public MirrorGewichtklasse getGewichtklasse() {
        return gewichtklasse;
    }

    public void setGewichtklasse(MirrorGewichtklasse gewichtklasse) {
