 ...
 */
@Entity
@Table(name = "tbl_pr_zu_dieselFloater", schema = "fak2")
@NamedQueries({
		@NamedQuery(name = MirrorDieselFloater.DIESELFLOATER_FIND_BY_IDX, query = "select df from MirrorDieselFloater df where df.d_idx = :idx") })
public class MirrorDieselFloater implements Serializable {

	private static final long serialVersionUID = 4106476294771316794L;

	public static final String DIESELFLOATER_FIND_BY_IDX = "MirrorDieselFloater.findByIdx";
