 ...
 */
@Entity
@Table(name = "TBL_KUNDE_SL", schema = "fak2")
public class MirrorKunde implements Serializable {
    ...
    private List<MirrorArtikel> kunden_artikel;
    ...
    public List<MirrorArtikel> getKunden_artikel() {
        return kunden_artikel;
    }

    public void setKunden_artikel(List<MirrorArtikel> kunden_artikel) {
